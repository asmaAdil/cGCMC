...
def construct_feed_dict_s(placeholders, u_features, v_features, u_features_nonzero, v_features_nonzero,
    ...
    # U x V
    feed_dict.update({placeholders['support_e']: support})
    feed_dict.update({placeholders['support_e_t']: support_t})
